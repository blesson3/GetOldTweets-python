...
while [ "$d" != "$d2" ]; do 
  ...
  echo "python ../GetTweets.py --querysearch \"$search\" --since \"${d}\" --until \"$next\" --output \"${fileNameFriendlySearch}_${d}.csv\" --maxtweets 1000000 > \"logs/${fileNameFriendlySearch}_${d}_log.out\" &"
